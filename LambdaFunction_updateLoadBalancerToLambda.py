...
def lambda_handler(event, context):
    ...
    updatedRule = elbv2.modify_rule(
        ...
        Actions=[
                {
                    'Type': 'forward',
                    'TargetGroupArn': 'arn:aws:elasticloadbalancing:eu-central-1:401827531924:targetgroup/TestCloudFunctionScaling/47a744c8240f3de7'
                }
            ]
    )
    ...
    return {
        'statusCode': 200,
        'body': json.dumps('Listener action updated to redirect to CF')
    }
